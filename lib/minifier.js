...
**/
exports.optimage = function(input, output, callback, level, verbose){
    ...
    var native_pngcush = function(input, output, callback){
    ...
    var native_pngquant = function(input, output, callback){
        fs.readFile(input, function (err, data) {
          if (err){
            return callback(err);
          }
    ...
    switch (extname){
        ...
        case '.png':
            ...
            doOptimize(function(){
                native_pngcush(output, output, function(){
                    native_pngquant(output, output, function(){
                        return callback(null, getInfo());
                    });
                });
            });
            return;
        ...
        case '.gif':
            ...
            args.push(input,'-o', output, '--colors', '256', '-O=' + (level || 2));
            break;
